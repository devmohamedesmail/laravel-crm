...
<body>
    ...
    <div class="container">
        <div class="row h-100 d-flex align-items-center justify-content-center" style="height: 100vh !important">
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header py-4 fw-bold fs-5 text-center">{{ __('translate.register') }}</div>
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="row mb-3">
                                <label for="name"
                                    class="d-block @if (LaravelLocalization::getCurrentLocale() == 'ar') text-end @endif">{{ __('translate.name') }}</label>
