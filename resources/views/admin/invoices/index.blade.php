                ...
                @foreach ($invoices as $invoice)
                    <tr>
                        ...
                        <td>
                            ...
                            <div class="dropdown">
                                <div tabindex="0" role="button" class="btn btn-primary btn-xs m-1">
                                    {{ __('translate.actions') }}</div>
                                <ul tabindex="0" class="dropdown-content menu bg-base-100 rounded-box z-[1]  p-2 shadow">
                                    <li><a href="{{ route('edit.invoice', $invoice->id) }}">{{ __('translate.edit') }}</a>
                                    </li>
                                    <li><a
                                            href="{{ route('print.invoice', $invoice->id) }}">{{ __('translate.print') }}</a>
                                    </li>
                                    <li><a href="{{ route('delete.invoice', $invoice->id) }}"
